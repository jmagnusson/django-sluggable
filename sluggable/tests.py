...
class TestUniqueTogetherSlug(TestCase):
    ...
    def test_unique_slug(self):
        ...
        slugged_model_one = UniqueTogetherSluggableModel(
            beta=self.beta_value_one,
            **self.model_kwargs
        )
        slugged_model_one.save()

        slugged_model_two = UniqueTogetherSluggableModel(
            beta=self.beta_value_one,
            **self.model_kwargs
        )
        slugged_model_two.save()
        ...
        slugged_model_three = UniqueTogetherSluggableModel(
            beta=self.beta_value_two,
            **self.model_kwargs
        )
